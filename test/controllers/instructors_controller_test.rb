...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { first_name: @instructor.first_name, last_name: @instructor.last_name, position: @instructor.position, title: @instructor.title }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { first_name: @instructor.first_name, last_name: @instructor.last_name, position: @instructor.position, title: @instructor.title }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
